        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{route('means.update', ['id'=>$mean->id])}}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div>
                            <div class="form-floating mb-3">
                                <input type="text" name="title" value="{{$mean->title ?? old('lenguage')}}"
                                    class="form-control" id="floatingInput" placeholder="name@example.com">
                                <label for="floatingInput">TITLE</label>
                            </div>
                            <div class="form-floating mb-3">
                                <select name="lenguage" value="{{$mean->lenguage ?? old('lenguage')}}"
                            ...
                            <div class="form-floating mb-3">
                                <input type="file" name="file" value="{{$mean->file ?? old('file')}}"
                                    class="form-control" id="floatingInput" placeholder="name@example.com">
                            ...
                            <div class="btn_container">
                                ...
                                <button class="btn btn-cancelar"><a
                                        href="{{route('means.index')}}">Cancelar</a></button>
                            </div>

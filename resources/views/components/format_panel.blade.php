<div class="container_format">
    ...
    <div class="d-flex justify-content-center panel_admin">
        <div class="option-admin">
            ...
            <a href="{{ route('means.create') }}"><img class="imagen_panel" src="{{ asset('./assets/archivo.png')}}"></a>
        </div>
        <div class="option-admin">
            <h3 class="subtitle">Link</h3>
            <a href="{{ route('means.create') }}"><img class="imagen_panel" src="{{ asset('./assets/grupo.png')}}"></a>
        </div>

...
<div class="container_format">
    ...
    <div class="d-flex justify-content-center panel_admin">
        <div class="option-admin">
            ...
            <a href="{{route('means.create', ['id'=>$format[0]->id])}}"><img class="imagen_panel" src="{{ asset('./assets/play.png')}}"></a>
        </div>
        <div class="option-admin">
            <h3 class="subtitle">Link</h3>
            <a href="{{route('means.create', ['id'=>$format[1]->id])}}"><img class="imagen_panel" src="{{ asset('./assets/enlace.png')}}"></a>
        </div>
        <div class="option-admin">

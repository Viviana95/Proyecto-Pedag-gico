...
<div class="container_format">
    ...
    <div class="d-flex justify-content-center panel_admin">
        <div class="option-admin">
             ...
             <a href="#"><img class="imagen_panel" src="{{ asset('./assets/archivo.png')}}"></a>
        </div>
        <div class="option-admin">
        ...
        <div class="option-admin" href="">
            ...
            <a href="#" class="ml-6 text-sl font-bold text_login"><img class="imagen_panel" src="{{ asset('./assets/usuario.png')}}"></a>

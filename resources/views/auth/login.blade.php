    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full text-login" type="email" name="email" :value="old('email')" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="password" class="block mt-1 w-full text-login"
                                type="password"
                                name="password"
